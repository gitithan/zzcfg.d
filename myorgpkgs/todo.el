...
;;-slfm-;;(setq org-todo-keyword-faces
;;-slfm-;;      (quote (("TODO" :foreground "orange" :weight bold)
;;-slfm-;;              ("NEXT" :foreground "red"    :weight bold)
;;-slfm-;;;              ("DONE" :foreground "forest green" :weight bold)
;;-slfm-;;              ("WAITING" :foreground "dark khaki" :weight bold)
;;-slfm-;;;              ("HOLD" :foreground "magenta" :weight bold)
;;-slfm-;;;              ("CANCELLED" :foreground "forest green" :weight bold)
;;-slfm-;;;              ("PHONE" :foreground "forest green" :weight bold)
;;-slfm-;;)))
